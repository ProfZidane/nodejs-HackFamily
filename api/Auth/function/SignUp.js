...
exports.functionSignup = ( req, res, next ) => {
...
exports.functionSignupGoogle = passport.authenticate('google', { scope: ['profile, email'] });

exports.functionSignupGoogleCallback = passport.authenticate('google', { failureRedirect: '/login' }), (req, res) => { res.redirect('/')};